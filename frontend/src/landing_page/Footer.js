        ...
        <div className="container border-top mt-5">
          <div className="row mt-5">
            <div className="col">
              ...
              <p>
                &copy; 2010 - 2024, Not trade Broking Ltd. all rights reserved.
              </p>
            </div>
          ...
          <div className="mt-5 text-muted" style={{ fontSize: "14px" }}>
            <p>
              TradePulse Broking Ltd.: Member of NSE, BSE, MCX & MSEI – SEBI
            ...
            <p>
              ...
              services, please create a ticket here. *Customers availing
              insurance advisory services offered by Ditto (Tacterial Consulting
              Private Limited | IRDAI Registered Corporate Agent (Composite)
              License No CA0738) will not have access to the exchange investor
              grievance redressal forum, SEBI SCORES/ODR, or arbitration
